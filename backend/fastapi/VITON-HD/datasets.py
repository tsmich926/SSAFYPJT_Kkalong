...
class VITONDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        print("dataset's getitem called")
        ...
        parse = Image.open(osp.join(self.data_path, 'image-parse', parse_name)).convert('P')
...
class VITONDataLoader:
    def __init__(self, opt, dataset):
        ...
        print("end VITONDataLoader init...")
